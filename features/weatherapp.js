...
//     document.getElementById('text').innerHTML = dates + " " + name + ", " + day + " ";
...
function fetchData() {
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=b6a20c093d78b4573edf3f989d9c56f5`)
        .then((response) => response.json())

        .then((response) => {
            console.log(response)
            document.getElementById("display-temp").innerHTML = `${response.main.temp}°C`;
